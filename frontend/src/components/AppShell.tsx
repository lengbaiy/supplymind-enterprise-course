...
import { useHermes } from "../app/hermes";
...
export function AppShell({ nav, items, organizationName, systemStatus = "ready", topbarActions, children, onNavigate, onRefresh, onLogout }: Props) {
