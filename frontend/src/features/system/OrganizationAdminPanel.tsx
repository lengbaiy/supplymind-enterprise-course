...
type Props = { organizations: PlatformOrganization[]; busy: boolean; onToggle: (organization: PlatformOrganization) => void; onRename: (organization: PlatformOrganization, name: string) => void };

export function OrganizationAdminPanel({ organizations, busy, onToggle, onRename }: Props) {
